                ...
                <li>
                  <div class="progress-container progress-primary">
                    ...
                    <ul class="list-unstyled team-info">
                      ...
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar2.jpg'" alt="Avatar" />
                      </li>
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar3.jpg'" alt="Avatar" />
                      </li>
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar4.jpg'" alt="Avatar" />
                      </li>
                    </ul>
                  </div>
                </li>
                <li>
                  <div class="progress-container">
                    ...
                    <ul class="list-unstyled team-info">
                      ...
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar10.jpg'" alt="Avatar" />
                      </li>
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar9.jpg'" alt="Avatar" />
                      </li>
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar8.jpg'" alt="Avatar" />
                      </li>
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar7.jpg'" alt="Avatar" />
                      </li>
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar6.jpg'" alt="Avatar" />
                      </li>
                    </ul>
                  </div>
                </li>
                <li>
                  <div class="progress-container progress-warning">
                    ...
                    <ul class="list-unstyled team-info">
                      ...
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar5.jpg'" alt="Avatar" />
                      </li>
                      <li>
                        <img :src="'dashboard/assets/images/xs/avatar2.jpg'" alt="Avatar" />
                      </li>
