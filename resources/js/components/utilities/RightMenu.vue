...
onMounted(() => {
  ...
  setTimeout(() => {
    ...
    if (div) {
      div.click(); // Programmatically trigger click event
    }
  }, 500);
});
</script>
          ...
          <div class="slim_scroll">
            ...
            <div class="card">
              ...
              <ul class="choose-skin list-unstyled">
                ...
                <li data-theme="blush" class="active" ref="myDiv">
                  <div class="blush"></div>
                </li>
              </ul>
            </div>
              ...
              <ul class="list-unstyled">
                <li class="online">
                  <a href="javascript:void(0);">
                    <div class="media">
                      <img class="media-object" :src="'dashboard/assets/images/xs/avatar4.jpg'" alt />
                ...
                <li class="online">
                  <a href="javascript:void(0);">
                    <div class="media">
                      <img class="media-object" :src="'dashboard/assets/images/xs/avatar5.jpg'" alt />
                      <div class="media-body">
                        <span class="name">
                          Grayson
                ...
                <li class="offline">
                  <a href="javascript:void(0);">
                    <div class="media">
                      <img class="media-object" :src="'dashboard/assets/images/xs/avatar2.jpg'" alt />
                      <div class="media-body">
                        <span class="name">
                          Isabella
                ...
                <li class="me">
                  <a href="javascript:void(0);">
                    <div class="media">
                      <img class="media-object" :src="'dashboard/assets/images/xs/avatar1.jpg'" alt />
                      <div class="media-body">
                        <span class="name">
                          John
                ...
                <li class="online">
                  <a href="javascript:void(0);">
                    <div class="media">
                      <img class="media-object" :src="'dashboard/assets/images/xs/avatar3.jpg'" alt />
                      <div class="media-body">
                        <span class="name">
                          Alexander
